...
;(function($,window,document,undefined) {
  ...
  var ZBox = {
    ...
    bi: function()
    {
      ...
      ZBox.im = $(imgHtml);
      var iw = img.width * 1.5;
      var ih = img.height * 1.5;
      var ww = ZBox.window.width() * 1.5 - ZBox.o.margin * 2;
      var wh = ZBox.window.height() * 1.5 - ZBox.o.margin * 2;
      var cw = ww - 80;
      var ch = wh - 20;
      var ca = cw/ch;
      var ia = iw/ih;
      ...
      ZBox.im.width( nw );
      ZBox.im.height( nh );
      ZBox.c.css('left', Math.ceil( ZBox.o.margin + (ww-(nw+800)) / 2 ) + 'px' );
      ZBox.c.css( 'top', Math.ceil( ZBox.o.margin + (wh-(nh+300)) / 2 ) + 'px' );
      if( ZBox.i.length > 1 )
      {
//        if( ZBox.cin > 0 )
        {
...
//        if( ZBox.cin+1 < ZBox.i.length )
    ...
    sm: function(mx,my)
    {
      function positionMag(evx,evy,evcx,evcy) {
        ...
        var msy = evy - imy;
        var mfx = 1.5 * msx/ZBox.d.nw; // Image width
        var mfy = 1.5 * msy/ZBox.d.nh;
